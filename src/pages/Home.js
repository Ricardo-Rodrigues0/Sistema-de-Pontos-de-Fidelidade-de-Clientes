...
function Home() {
    return (
        <div className='mainHome'>
            ...
            <section className='section1'>
                <img className='banner' src='./image/BannerLogos/bannerHome1.png' alt='Banner' />
                    ...
                    <div id="carouselExampleRide" className="carousel slide" data-bs-ride="true">
                        <div className="carousel-inner">
                            ...
                            <div className="carousel-item active">
                                <img src="/image/groupCar/hatch/ARGO.png" className="d-block mx-auto w-10" alt="Fiat Argo" />
                            ...
                            <div className="carousel-item">
                                <img src="/image/groupCar/pick-up/S10X.png" className="d-block mx-auto w-10" alt="Chevrolet S10" />
                            ...
                            <div className="carousel-item">
                                <img src="/image/groupCar/premium/HAVA.png" className="d-block mx-auto w-10" alt="Haval H6" />
                            ...
                            <div className="carousel-item">
                                <img src="/image/groupCar/sedan/SETA.png" className="d-block mx-auto w-10" alt="Nissan Sentra" />
                            ...
                            <div className="carousel-item">
                                <img src="/image/groupCar/suv/CRTA.png" className="d-block mx-auto w-10" alt="Hyundai Creta" />
                    ...
                    <div className="card-group  justify-content-center">
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/hatch/HB2X.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Hyundai HB20" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/hatch/ONIC.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Chevrolet Onix" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/pick-up/S10X.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Chevrolet S10" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/pick-up/TO4D.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Fiat Toro" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/premium/COLB.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Toyota Corolla" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/premium/AUD3.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Audi A3" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/sedan/CROM.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Fiat Cronos" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/sedan/VIRF.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Virtus" />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card h-100" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <div className="card-body d-flex flex-column text-center">
                                    <img src="/image/groupCar/suv/CRTA.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }} alt="Hyundai Creta" />
    ...
    <button 
        type="button" 
        className="btn btn-success mx-3 mb-5 px-5" 
        onClick={() => window.location.href = "./products"}>
        Confira a variedade de produatos
    </button>
</div>
            ...
            <section className='section2'>
                <img className='banner' src='./image/BannerLogos/bannerHome2.png' alt='Banner' />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <img src="/image/groupCar/hatch/HB2X.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }}
                                        alt="Hyundai HB20" />
                                    <p className="card-text mt-3">Compacto e prático, o hatch é perfeito para o dia a dia, combinando agilidade e economia.</p>
                                            ...
                                            <div id="carouselExample" className="carousel slide">
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="carousel-item active">
                                                        ...
                                                        <img src="/image/groupCar/hatch/ARGO.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/hatch/GOLC.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/hatch/HB2X.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/hatch/KWID.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/hatch/POLO.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/hatch/ONIC.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <img src="/image/groupCar/pick-up/FRON.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }}
                                        alt="Nissan Frontier" />
                                            ...
                                            <div id="carouselExample2" className="carousel slide">
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="carousel-item active">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/FRON.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/L200.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/MONP.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/S10X.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/TO4D.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/pick-up/TOYH.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <img src="/image/groupCar/sedan/CROM.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }}
                                        alt="Fiat Cronos" />
                                            ...
                                            <div id="carouselExample3" className="carousel slide">
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="carousel-item active">
                                                        ...
                                                        <img src="/image/groupCar/sedan/CROM.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/sedan/HB2C.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        <h4 className="text-dark text-center">Chevrolet Onix</h4>
                                                        <img src="/image/groupCar/sedan/ONIS.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/sedan/SETA.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/sedan/VIRF.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                        ...
                        <div className="col-sm-3 mb-3 mx-2">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <img src="/image/groupCar/premium/AUD3.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }}
                                        alt="Audi A3" />
                                            ...
                                            <div id="carouselExample4" className="carousel slide">
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="carousel-item active">
                                                        ...
                                                        <img src="/image/groupCar/premium/AUD3.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/premium/CMDR.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/premium/COLB.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/premium/EQBL.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/premium/HAVA.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/premium/SONG.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                        ...
                        <div className="col-sm-3 mb-5 mx-2">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <img src="/image/groupCar/suv/FATB.png" className="img-fluid" style={{ height: '150px', objectFit: 'contain' }}
                                        alt="Fiat Fastback" />
                                            ...
                                            <div id="carouselExample5" className="carousel slide">
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="carousel-item active">
                                                        ...
                                                        <img src="/image/groupCar/suv/CRTA.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/suv/FATB.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/suv/KICK.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/suv/NIVU.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/suv/PLSE.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />
                                                    ...
                                                    <div className="carousel-item">
                                                        ...
                                                        <img src="/image/groupCar/suv/TRAT.png" className="img-fluid d-block mx-auto" style={{ height: '200px', objectFit: 'contain' }} alt="..." />

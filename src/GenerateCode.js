...
import { useNavigate, Link } from 'react-router-dom'; // Altere aqui
                    ...
                    <h2 className="mt-5 mb-5 text-center">Gere seu Código</h2>
                        <form>
                            ...
                            <div className="btn-group mt-3" role="group" aria-label="Botões de ação">
                                <button type="button" className="btn btn-primary" onClick={handleGenerateCode}>Gerar Código</button>
                                <button type="submit" className="btn btn-success" onClick={() => navigate('/codelist')}>Ver Códigos gerados</button>
                            </div>
                        </form>
                    </div>
                </div>
